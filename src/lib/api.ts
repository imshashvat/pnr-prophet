...
export type PredictResponse = { confirmation_chance: number; top_factors: string[]; input: any };
...
export const Api = {
  ...
  predict: (payload: { train_no: string; wl_position: number; day_of_week: number; distance: number; status: string; clazz: string }) =>
